...
function clues() {
    ...
    fill("red")
    textSize(20)
    text("The Jumbled words and clues are given in white colour relating to coding.", 150,20);    
...
// add code for displaying rest of the names and the hints.
    ...
    fill("lightblue")
    text("Hint: Performs In Particular Tasks !!", 700,70)

    fill("white")
    textSize(15)
    text("A T E D A S B A", 400,250)
    fill("lightblue")
